...
class Module_ComposerAPI
{
    ...
    protected function call_command ($command, array $arguments = null, 
    ...
    /**
     * Reads the composer.json file from the current directory, resolves the
     * dependencies, and installs them: see
    ...
    {
        return $this->call_command('install', 
                $this->prepare_array_input_args($options), $output);
    }

    /**
     * Updates dependencies to the latest possible version and updates the
     * composer.lock file: see https://getcomposer.org/doc/03-cli.md#update
     * E.g.
     * $composer->update() will update all dependencies while
     * $composer->update(array('symfony/css-crawler'),
     * array('--optimize-autoloader'))
     * will update only the CSS crawler symfony component optimizing the
     * autoloader afterwards.
     *
     * @param OutputInterface $output            
     * @return \Symfony\Component\Console\Output\OutputInterface
     */
    public function update (array $package_names = null, array $options = null, 
            OutputInterface $output = null)
    {
        $arguments = array();
    ...
    /**
     * Installes one or more packages: see
     * https://getcomposer.org/doc/03-cli.md#require.
     * E.g. $composer->require(array('monolog/monolog:~1.16', 'slim/slim')) will
     * install monolog in version 1.16
     ...
     * @return \Symfony\Component\Console\Output\OutputInterface
     */
    public function requirePackage (array $package_names, array $options = null, 
            OutputInterface $output = null)
    {
        $arguments = array();
        ...
        if (is_array($package_names) && count($package_names) > 0) {
            ...
            throw new \InvalidArgumentException(
                    'The require command requires at least one package name - none given!');
        }
    ...
    /**
     * Uninstalles one or more packages: see
     * https://getcomposer.org/doc/03-cli.md#remove.
     * E.g. $composer->remove(array('monolog/monolog', 'slim/slim')) will
     * uninstall monolog in version 1.16
     * or later and the Slim framework in the latest available version.
     *
     * @param array $package_names            
     * @param array $options            
     ...
     * @return \Symfony\Component\Console\Output\OutputInterface
     */
    public function remove (array $package_names, array $options = null, 
            OutputInterface $output = null)
    {
        $arguments = array();
    ...
    /**
     * Search through the current project's package repositories: see
     * https://getcomposer.org/doc/03-cli.md#search
     *
     ...
     * @return \Symfony\Component\Console\Output\OutputInterface
     */
    public function search (array $search_terms, array $options = null, 
            OutputInterface $output = null)
    {
        $arguments = array();
    ...
    /**
     * Lists all installed packages: see
     * https://getcomposer.org/doc/03-cli.md#show.
     * E.g. $composer->show(array('--latest')) will show all packages with the
     * respective latest version available
     *
     * @param array $options            
     * @param OutputInterface $output            
     * @return \Symfony\Component\Console\Output\OutputInterface
    ...
    {
        return $this->call_command('show', 
                $this->prepare_array_input_args($options), $output);
    }

    /**
     * Shows a list of installed packages that have updates available, including
     * their current and latest versions: see
     * https://getcomposer.org/doc/03-cli.md#outdated
     * E.g.
     * $composer->outdated() will list only outdated packages while
     * $composer->outdated(array('--all')) will list alle packages
    ...
    {
        return $this->call_command('outdated', 
                $this->prepare_array_input_args($options), $output);
    }

    /**
     * Lists all packages suggested by currently installed set of packages: see
     * https://getcomposer.org/doc/03-cli.md#suggests.
     * E.g. $composer->suggests(array('monolog/monolog', 'slim/slim'),
     * array('--by-package')) will show packages
     ...
     * @return \Symfony\Component\Console\Output\OutputInterface
     */
    public function suggests (array $package_names = null, array $options = null, 
            OutputInterface $output = null)
    {
        $arguments = array();
    ...
    /**
     * Tells you which other packages depend on a certain package: see
     * https://getcomposer.org/doc/03-cli.md#depends.
     * E.g. $composer->depends('doctrine/lexer', array('--tree')) will show
     * packages, that require the doctrine lexer
     ...
     * @return \Symfony\Component\Console\Output\OutputInterface
     */
    public function depends ($package_name, $version = null, array $options = null, 
            OutputInterface $output = null)
    {
        $arguments = array();
    ...
    /**
     * Tells you which packages are blocking a given package from being
     * installed: see https://getcomposer.org/doc/03-cli.md#prohibits.
     * E.g. $composer->prohibits('symfony/symfony', '3.1', array('--tree')) will
     * show packages in your current project,
     * that would prevent the installation of Symfony 3.1 with all their
     * subrequirements in the form of a tree.
     *
     * @param string $package_name            
     * @param string $verion            
     * @param array $options            
     ...
     * @return \Symfony\Component\Console\Output\OutputInterface
     */
    public function prohibits ($package_name, $version = null, array $options = null, 
            OutputInterface $output = null)
    {
        $arguments = array();
    ...
    /**
     * Validates the composer.json file: see
    ...
    {
        return $this->call_command('validate', 
                $this->prepare_array_input_args($options), $output);
    }

    /**
     * Edits config settings and repositories in either the composer.json file:
     ...
     * @return \Symfony\Component\Console\Output\OutputInterface
     */
    public function config ($setting_key, array $setting_values, 
            array $options = null, OutputInterface $output = null)
    {
        $arguments = array();
        ...
        if ($setting_key != '') {
            ...
            throw new \InvalidArgumentException(
                    'Invalid setting key "' . $setting_key . '"!');
        }
